document.addEventListener('DOMContentLoaded', () => {
    const lines = [
        ...
        { elementId: 'line3', text: "I'm interested in UI/UX design and database development. Currently, learning and building my skills through projects and hands-on exploration." }
    ];
